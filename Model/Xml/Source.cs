...
public class Source : TranslationUnitContentContainer
{
    public override TranslationUnitContentType ContentType { get; internal set; } = TranslationUnitContentType.Source;
